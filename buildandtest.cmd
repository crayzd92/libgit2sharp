...
"%userprofile%\.nuget\packages\xunit.runner.console\2.6.6\tools\net481\xunit.console.exe" "%~dp0bin\LibGit2Sharp.Tests\%Configuration%\net481\LibGit2Sharp.Tests.dll" -noshadow
@IF ERRORLEVEL 1 EXIT /B %ERRORLEVEL%
