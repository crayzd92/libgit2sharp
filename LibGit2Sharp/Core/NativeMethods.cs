...
namespace LibGit2Sharp.Core
{
    internal static class NativeMethods
    {
        ...
        [DllImport(libgit2, CallingConvention = CallingConvention.Cdecl)]
        internal static extern unsafe int git_transaction_commit(git_transaction* txn);

        [DllImport(libgit2, CallingConvention = CallingConvention.Cdecl)]
        internal static extern unsafe void git_transaction_free(git_transaction* txn);
